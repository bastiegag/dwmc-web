...
This is the frontend roadmap only. It separates shipped behavior from work that remains a placeholder or future possibility. Backend contract work belongs in the sibling `dwmc-api` repository.
